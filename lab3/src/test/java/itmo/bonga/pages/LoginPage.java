...
public class LoginPage {
    ...
    private final By iframeLocator = By.cssSelector(
            ".ag-popup__frame_layout__iframe, iframe.ag-popup__frame_layout_iframe, iframe[src*='account.mail.ru/login']");
    ...
    private final By usernameInputFallback7 = By.xpath(
            "/html/body/div/div/div/div/div/div/div/div/div/div/div/div/div[2]/form/fieldset/div[1]/span/div/div/input");

    private final By nextButtonLocator = By.cssSelector("button.base-0-2-79.primary-0-2-93[type='submit']");
    private final By nextButtonLocator2 = By
            .xpath("//*[@id=\"root\"]/div/div/div/div[2]/div/form/div[2]/div[5]/div[3]/div/div/div[1]/button");
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                return wait
                                        .until(ExpectedConditions.visibilityOfElementLocated(usernameInputFallback5));
                            } catch (Exception e5) {
                                System.out.println("Fallback 5 failed, trying fallback 6");
                                try {
                                    return wait.until(
                                            ExpectedConditions.visibilityOfElementLocated(usernameInputFallback6));
                                } catch (Exception e6) {
                                    System.out.println("Fallback 6 failed, trying fallback 7");
                                    return wait.until(
                                            ExpectedConditions.visibilityOfElementLocated(usernameInputFallback7));
                                }
                            }
                        }
                    }
